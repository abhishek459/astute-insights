    ...
    >
      ...
      >
        <h1 class="text-3xl font-bold tracking-tight">
          Seeing Ourselves in the Stories We're Told
        </h1>
      </header>
      ...
      <div class="max-w-3xl w-full p-4 sm:p-6 lg:p-8">
        ...
        <Section>
          <SubHeading>Noticing Together</SubHeading>
          <p>
            I don't have all the answers. I am just a person trying to see all
            of this more clearly, too. I've found that the more I try to
            understand my own reactions to the world, the quieter and more
            peaceful things become.
          </p>
